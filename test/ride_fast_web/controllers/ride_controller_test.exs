defmodule RideFastWeb.RideControllerTest do
  ...
  @update_attrs %{
    ...
    started_at: ~N[2025-11-26 18:31:00],
    origin_lat: 456.7,
    origin_lng: 456.7,
    dest_lat: 456.7,
    dest_lng: 456.7,
    ...
    final_price: "456.7",
    requested_at: ~N[2025-11-26 18:31:00],
    ended_at: ~N[2025-11-26 18:31:00]
  }
  ...
  describe "create ride" do
    test "renders ride when data is valid", %{conn: conn} do
      ...
      assert %{
               ...
               "dest_lat" => 120.5,
               "dest_lng" => 120.5,
               "ended_at" => "2025-11-25T18:31:00",
               "final_price" => "120.5",
               "origin_lat" => 120.5,
               "origin_lng" => 120.5,
               "price_estimate" => "120.5",
               "requested_at" => "2025-11-25T18:31:00",
               "started_at" => "2025-11-25T18:31:00",
               "status" => "some status"
  ...
  describe "update ride" do
    ...
    test "renders ride when data is valid", %{conn: conn, ride: %Ride{id: id} = ride} do
      ...
      assert %{
               ...
               "dest_lat" => 456.7,
               "dest_lng" => 456.7,
               "ended_at" => "2025-11-26T18:31:00",
               "final_price" => "456.7",
               "origin_lat" => 456.7,
               "origin_lng" => 456.7,
               "price_estimate" => "456.7",
               "requested_at" => "2025-11-26T18:31:00",
               "started_at" => "2025-11-26T18:31:00",
               "status" => "some updated status"
             } = json_response(conn, 200)["data"]
    end
