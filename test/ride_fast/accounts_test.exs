defmodule RideFast.AccountsTest do
  ...
  describe "driver_profiles" do
    ...
    test "create_driver_profile/1 with valid data creates a driver_profile" do
      valid_attrs = %{license_number: "some license_number", license_expiry: ~D[2025-11-25], background_check_ok: true}
      ...
      assert driver_profile.license_expiry == ~D[2025-11-25]
    ...
    test "update_driver_profile/2 with valid data updates the driver_profile" do
      driver_profile = driver_profile_fixture()
      update_attrs = %{license_number: "some updated license_number", license_expiry: ~D[2025-11-26], background_check_ok: false}
      ...
      assert driver_profile.license_expiry == ~D[2025-11-26]
